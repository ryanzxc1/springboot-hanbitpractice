...
public class HomeController {
    ...
    public String postPassword(@ModelAttribute("password") PasswordForm passwordForm, BindingResult bindingResult, @AuthenticationPrincipal MemberUserDetails userDetails){

        if(!memberService.checkPassword(userDetails.getMemberId(), passwordForm.getOld())){
            bindingResult.rejectValue(
                    "old","MissMatch","비밀번호가 잘못 되었습니다"
            );
        }
